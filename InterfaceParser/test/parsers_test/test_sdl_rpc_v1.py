...
class TestSDLRPCV1Parser(unittest.TestCase):
    ...
    def setUp(self):
        """Test initialization."""
        valid_xml_name = Path(__file__).parents[0].joinpath('valid_SDLRPCV1.xml').as_posix()
    ...
    def test_structure_struct2(self):
        ...
        self.assertIs(member.param_type.element_type,
                      self.interface.structs["struct1"])
    ...
    def test_function_request_function1(self):
        ...
        """
        self.assertIn(
            (self.interface.enums["FunctionID"].elements["Function1"],
    ...
    def test_function_response_function1(self):
        ...
        self.assertIs(param.param_type.elements["element2"], self.interface.enums["enum1"].elements["element2"])
    ...
    def test_function_notification_function2(self):
        ...
        """
        self.assertIn(
            (self.interface.enums["FunctionID"].elements["Function2"],
